...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-geojson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15212&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-geojson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-geojson` can be installed with:

```
conda install napari-geojson
```

It is possible to list all of the versions of `napari-geojson` available on your platform with:
